            ...
            <div className="flex-[9]">
              <div className="flex justify-between items-center gap-2">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-400">{product.watt} Watt</p>
                </div>
              ...
              <div className="mt-4 flex justify-between items-center">
                ...
                <Link
                  ...
                  className="bg-orange-600 px-7 py-3 max-sm:px-4 max-sm:text-xs rounded-full text-sm text-white font-semibold"
                >
                  Buy Now
                </Link>
              </div>
