  ...
  return (
    <div className="w-full px-5 mx-auto total-width flex flex-wrap justify-between items-start py-8">
      ...
      <ul className="text-white">
        ...
        <li className=" text-slate-400 mt-4">greatlumen.dnh@gmail.com</li>
        <li className=" mt-8 flex items-center gap-3">
          <a
            href="/"
            className=" h-10 w-10  flex items-center justify-center rounded-full bg-secondary p-2"
          >
          ...
          <a
            href="/"
            className=" h-10 w-10  flex items-center justify-center rounded-full  bg-orange-600 p-2"
          >
